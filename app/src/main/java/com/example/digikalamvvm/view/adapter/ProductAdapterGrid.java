...
import com.example.digikalamvvm.databinding.RecyclerviewGridItemsBinding;
...
public class ProductAdapterGrid extends RecyclerView.Adapter<ProductAdapterGrid.MyViewHolder>{

    private ProductViewmodel viewmodel;
    private List<Product> list;
    Context context;
    public ProductAdapterGrid(ProductViewmodel productViewmodel) {
    ...
    public MyViewHolder onCreateViewHolder(  ViewGroup parent, int viewType) {
        RecyclerviewGridItemsBinding binding=RecyclerviewGridItemsBinding.inflate(LayoutInflater.from(parent.getContext()),parent,false);
        context=parent.getContext();
        return new MyViewHolder(binding);
    }

    @Override
    public void onBindViewHolder(ProductAdapterGrid.MyViewHolder holder, int position) {
        ...
        holder.binding.parentLayoutGrid.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    class MyViewHolder extends RecyclerView.ViewHolder{
        RecyclerviewGridItemsBinding binding;

        public MyViewHolder( RecyclerviewGridItemsBinding itemView) {
